...
MediaRecorder.prototype = {
   ...
   * })
    ...
    start: function start (timeslice) {
        if (this.state === 'inactive') {
            ...
            if (!window.illAudioContext) {
                window.illAudioContext = new AudioContext()
            }

            this.input = window.illAudioContext.createMediaStreamSource(this.stream)
            this.processor = window.illAudioContext.createScriptProcessor(2048, 1, 1)
            ...
            this.processor.connect(window.illAudioContext.destination)
   ...
   * })
    ...
    requestData: function requestData () {
        if (this.state !== 'inactive') {
            this.encoder.postMessage(['dump', window.illAudioContext.sampleRate])
        }
    },
