...
jp_podcast_parser.add_argument("--website", "--w", type=str, help="Enter the page manually")
...
jp_podcast_parser.add_argument("--clear", "--c", action="store_true", help="clears old files")
jp_podcast_parser.add_argument(
